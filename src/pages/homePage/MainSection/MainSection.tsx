...
export const MainSection = () => {
    return (
        <div className="w-full h-auto relative font-poppins ">
            ...
            <div className="flex justify-center items-center w-[643px] h-[443px] absolute top-[190px] left-[778px] rounded-tl-lg bg-[#FFF3E3]">
                <div className="flex flex-col justify-center w-[561px] h-[344px] left-[778px]">
                    <div className="w-[123px] h-[24px] text-left text-sm font-semibold leading-[24px] tracking-[3px] text-[#333333]">
                        <p>New Arrival</p>
                    </div>
                    ...
                    <div className="w-[546px] h-[52px] text-lg font-medium leading-6 text-left text-[#333333]">
                        <p>
                    ...
                    <div className="flex items-center justify-center w-[222px] h-[74px] mt-10 px-[72px] py-[25px] gap-[10px] bg-[#B88E2F]">
